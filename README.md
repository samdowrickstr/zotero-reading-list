...
- record per-item reading tasks for modules and units with pages, chapters, or paragraphs; module names you enter are saved for quick selection, and tasks are managed in one dialog with status options that update the overall read status

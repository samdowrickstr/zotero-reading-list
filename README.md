...
- record per-item reading tasks for modules and units with pages, chapters, or paragraphs; tasks are managed in one dialog with status options that update the overall read status
